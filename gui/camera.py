...
class Camera():
	...
	def move(self, axis_id, direction):
		...
		# it could be really optymalized, but for readibility let it be as is:
		...
		# Not implemented yet and unneccessary
		# to calc this vector you need to get diffrence between eye and look_at
